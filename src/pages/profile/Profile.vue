<template>
  <div id="profile">
    <nav-bar class="nav-bar">
      <div slot="center">www.networkvvv.top</div>
    </nav-bar>
...
<script>
import UserInfo from "@/pages/profile/profileView/UserInfo";
import ListView from '@/pages/profile/profileView/ListView'
import NavBar from "@/components/commonV/navbar/NavBar";
